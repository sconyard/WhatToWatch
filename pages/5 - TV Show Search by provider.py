...
st.info('Want to limit your search to a specific watch provider? Select a watch provider and a genre and we will find the top rated TV shows to watch.')

api_key = '**enter your api key here**'

wprovider_api = f'https://api.themoviedb.org/3/watch/providers/tv?api_key={api_key}&language=en-US&watch_region=GB'
...
tvshow_api = f'https://api.themoviedb.org/3/discover/tv?api_key={api_key}&language=en-US&with_watch_providers={selected_wprovider_code}&watch_region=GB&with_genres={selected_genre_code}'
